    ...
    <nav className="w-full sticky top-0 z-50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden backdrop-blur supports-[backdrop-filter]:bg-accent/60 md:flex bg-accent/70 px-4 py-2 rounded-full items-center gap-6">
            ...
            <Link href="/support" className="text-base font-medium">
              Support
            </Link>
          </div>
